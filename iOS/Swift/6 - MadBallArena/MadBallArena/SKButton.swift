...
class SKButton: SKSpriteNode {
    ...
    * Init
    */
    init(normalImageNamed: String, highlightedImageNamed: String? = nil, disabledImageNamed: String? = nil, size: CGSize? = nil, buttonFunc: ((button: SKButton) -> Void)? = nil) {
        let record = Record()
    ...
    init(normalTexture: SKTexture, highlightedTexture: SKTexture? = nil, disabledTexture: SKTexture? = nil, buttonFunc: ((button: SKButton) -> Void)? = nil) {
        let record = Record()
    ...
    init(normalString: String, normalFontName: String? = nil, normalFontSize: CGFloat? = nil, normalStringColor: UIColor? = nil, backgroundNormalColor: UIColor? = nil, size: CGSize? = nil, cornerRadius: CGFloat? = nil, buttonFunc: ((button: SKButton) -> Void)? = nil) {
        let record = Record()
