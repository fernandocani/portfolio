//
//  ContasPagasTableViewController.m
//  Trabalho 6
//
...
#import "ContasPagasTableViewController.h"
#import "ListaContas.h"
#import "Conta.h"
#import "TableViewCell.h"

@interface ContasPagasTableViewController (){
    ListaContas *listaC;
    int selectedIndex;
}
...
@implementation ContasPagasTableViewController
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section {
    ...
    return [listaC countPagas];
}


- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"contasPagasCell" forIndexPath:indexPath];
    
    Conta* conta = [[listaC trazContasPagas] objectAtIndex:indexPath.row];
...
- (IBAction)trashBtnClick:(id)sender {
    _trashBtn.enabled = NO;
    [listaC removeConta:selectedIndex Tela:@"paga"];
    [self.tableView reloadData];
}
